    ...
    >
      ...
      >
          ...
          >
            <div
              style={{
                ...
                background: product.collarColor
              }}
            />
            <span
              style={{
        ...
        <div style={{ padding: '16px 4px 8px' }}>
          <div style={{ marginBottom: 4, fontSize: 16, fontWeight: 500, color: '#3D3530' }}>
            {product.name}
          </div>
          <div style={{ marginBottom: 14, fontSize: 13, lineHeight: 1.5, color: '#9B948F' }}>
            {product.desc}
          </div>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16 }}>
            <div style={{ fontSize: 20, fontWeight: 500, color: '#3D3530' }}>
              {product.price}
              <span style={{ marginLeft: 6, fontSize: 12, fontWeight: 400, color: '#9B948F' }}>
                · 5 charms
              </span>
            </div>
            <span style={{ fontSize: 13, fontWeight: 500, color: '#2a5a25' }}>
              View details →
            </span>
          </div>
        </div>
