          ...
          <div>
            ...
            {selectedCharm && (
              <div style={{ marginTop: 28, display: 'flex', alignItems: 'center', gap: 12 }}>
                <div style={{ width: 44, height: 44, borderRadius: '50%', background: selectedCharm.bg, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22 }}>{selectedCharm.e}</div>
                <div>
